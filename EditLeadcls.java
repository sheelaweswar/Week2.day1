...
public class EditLeadcls {
	public static void main(String[] args) {
	    ...
	    objcrmdriver.findElement(By.linkText("Edit")).click();
	    WebElement updcrptn = objcrmdriver.findElement(By.id("updateLeadForm_description"));
	    updcrptn.clear();
	    WebElement imptnote = objcrmdriver.findElement(By.name("importantNote"));
	    imptnote.sendKeys("Type the important info here");
	    String edleadtitle = objcrmdriver.getTitle();
	    System.out.println(edleadtitle);
	    objcrmdriver.findElement(By.className("smallSubmit")).click();
	    String edleadtitle1 = objcrmdriver.getTitle();
	    System.out.println(edleadtitle1);
	    objcrmdriver.close();
